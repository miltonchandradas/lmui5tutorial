		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple tutorial - Lockheed Martin",
									"targetURL": "#comsaplmui5tutorial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplmui5tutorial-display": {
								"semanticObject": "comsaplmui5tutorial",
								"action": "display",
								"description": "Simple tutorial - Lockheed Martin",
								"title": "Simple tutorial - Lockheed Martin",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lmui5tutorial",
									"url": sap.ui.require.toUrl("com/sap/lmui5tutorial")
								}
							}
						}
					}
